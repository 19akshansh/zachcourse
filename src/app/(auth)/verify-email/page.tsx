      ...
      try {
        ...
        if (res?.error) {
          ...
          if (msg.includes("already") || msg.includes("already verified") || res.error.code === "EMAIL_ALREADY_VERIFIED") {
            toast.info("Email already verified — signing you in");
            setStatus("success");
            setTimeout(() => {
              navigate("/dashboard");
            }, 2000);
            ...
            toast.error("Invalid or expired verification link");
            setStatus("error");
            setErrorMsg(res.error.message || "Invalid or expired verification link");
          }
        } else {
          toast.success("Email verified! Welcome to ZachCourse 🎉");
          setStatus("success");
        ...
        <div className="text-center py-6 relative">
          ...
          {status === "success" && (
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-xl font-extrabold text-[#FAF9FD] tracking-tight mb-2">Email verified!</h2>
              <p className="text-sm text-[#8E88AB] mb-5 font-medium">Your credentials have been successfully confirmed.</p>
          ...
          {status === "error" && (
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-xl font-extrabold text-[#FAF9FD] tracking-tight mb-2">Verification Failed</h2>
