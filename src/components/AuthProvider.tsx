  ...
  if (isPending) {
    return (
      <main className="min-h-screen bg-[#0A0A0F] flex flex-col items-center justify-center text-[#F8FAFC] p-6 text-center select-none relative overflow-hidden font-sans">
        ...
        <div className="absolute top-1/4 left-1/4 w-[350px] h-[350px] bg-gradient-to-tr from-[#4F46E5]/10 to-[#8B5CF6]/5 rounded-full blur-3xl pointer-events-none -z-10 animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[350px] h-[350px] bg-gradient-to-bl from-[#8B5CF6]/10 to-[#4F46E5]/5 rounded-full blur-3xl pointer-events-none -z-10"></div>
